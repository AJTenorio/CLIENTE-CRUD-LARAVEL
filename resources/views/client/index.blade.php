...
@section('content')
    <div class = "container py-5 text-center">
        ...
        @if (Session::has('mensaje'))
            <div class="alert aletr-info my-5">
                {{Session::get('mensaje')}}
            </div>
        @endif
                    ...
                    <tr>
                        ...
                        <td> 
                            ...
                            <form action="{{ route('client.destroy', $detail ) }}" method="post" class="d-inline">
                                @method('DELETE')
                                @csrf
                                <button type="submit" class="btn btn-danger" onclick="return comfirm('Estas seguro de querer eliminar este Cliente')">ELiminar</button>
                            </form>
